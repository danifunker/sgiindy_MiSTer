...
**The card could not take it.** It is full (§8 of docs/50: ~37 GB of orphaned
...
instruction cache the traces in docs/50 already asked for.
...
since docs/50: the bridge takes a new command while earlier reads are still
