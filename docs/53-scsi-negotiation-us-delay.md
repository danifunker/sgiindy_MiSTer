...
Written 2026-09-17, resuming docs/52 §7's list. Its first item was the disk's
...
iterations of a two-instruction loop). docs/50 named its callers from a
...
**Build 40** = build 39 + `claude/fill-comb` (docs/52 §5: a data line fill's
