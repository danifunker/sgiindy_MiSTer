...
docs/reference/mister-integration.md section 0 planned "split the planes, the display reads RGB only":
8 -> 4 bytes a pixel, 0.80 -> 0.39 words a clock at `PIX_DIV=1`. Since docs/design/newport-vdma.md
