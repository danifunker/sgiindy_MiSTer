...
counts: the R4400 identity `docs/reference/cpu.md` argues for, the 16 KB
...
Each file's header carries the reasoning; `docs/reference/address-map.md` has the
...
the descriptor format are in [13-scsi-dma-plan.md](../history.md#13); what
