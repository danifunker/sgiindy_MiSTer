...
`docs/reference/mister-integration.md` is the top level itself and the list of what is
...
`tools/misterdeploy/` is for the day `docs/reference/nvram.md` lands and
...
`docs/reference/mister-integration.md` has the full list. The three that decide the
first ten minutes:
